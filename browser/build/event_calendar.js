...
Event_Calendar.Templates = {
  "full_inputs": "<div class='row freqRow'> <label>Repeats:<a class='inlineHelp' data-help='The unit of time used to determine how often the event should repeat e.g. monthly. Defaults to \"never\".'><i class='icon-question-sign'></i></a></label></label> <select class='freq'><option value=''>Never</option><option value='daily'>Daily</option><option value='weekly'>Weekly</option><option value='monthly'>Monthly</option><option value='yearly'>Yearly</option></select><div class='nextOccurrence'></div></div><div class='row intervalRow'> <label>Every:<a class='inlineHelp' data-help='This value works with the \"repeats\" unit of time to determine how often the event will repeat e.g. 2 with \"monthly\" means every 2 months. Defaults to 1.'><i class='icon-question-sign'></i></a></label></label> <input type='number' class='interval' min='1'/><span class='intervalTimeUnit'></span></div><div class='row weekDayRow'> <label>On:<a class='inlineHelp' data-help='Use this value if the event needs to repeat on one or more days of the week e.g. Monday and Wednesday.'><i class='icon-question-sign'></i></a></label><div class='weekDayContainer'></div></div><div class='row monthDayRow'> <label>On:<a class='inlineHelp' data-help='Select \"Day\" and one of the days of the month if the event needs to repeat on one or more days of the month e.g. the 1st and the 15th. Select \"First\", \"Second\", \"Third\", \"Fourth\" or \"Last\" if the event needs to repeat on the first, second, third fourth or last day of the week that will appear in a drop down menu to the right.'><i class='icon-question-sign'></i></a></label> <select class='monthDayOccurrenceNumber'><option value='day'>Day</option><option value='' disabled='disabled'></option><option value='1'>First</option><option value='2'>Second</option><option value='3'>Third</option><option value='4'>Fourth</option><option value='-1'>Last</option></select><div class='monthDayContainer'><div class='pushButtonContainer'></div><div class='selectContainer'> <select class='monthDayDropDown'><option value='su'>Sunday</option><option value='mo'>Monday</option><option value='tu'>Tuesday</option><option value='we'>Wednesday</option><option value='th'>Thursday</option><option value='fr'>Friday</option><option value='sa'>Saturday</option><option value='' disabled='disabled'></option><option value='day'>Day</option><option value='weekday'>Weekday</option><option value='weekendday'>Weekend Day</option></select></div></div></div><div class='row yearMonthRow'> <label>In:<a class='inlineHelp' data-help='You can limit the months the event will repeat in by selecting one or more months.'><i class='icon-question-sign'></i></a></label><div class='yearMonthContainer'></div></div><div class='row yearDayRow'> <label>On:<a class='inlineHelp' data-help='Select \"First\", \"Second\", \"Third\", \"Fourth\" or \"Last\" if the event needs to repeat on the first, second, third fourth or last day of the week that will appear in a drop down menu to the right.'><i class='icon-question-sign'></i></a></label> <select class='yearDayOccurrenceNumber'><option value=''></option><option value='1'>First</option><option value='2'>Second</option><option value='3'>Third</option><option value='4'>Fourth</option><option value='-1'>Last</option></select> <select class='yearDayDropDown'><option value='su'>Sunday</option><option value='mo'>Monday</option><option value='tu'>Tuesday</option><option value='we'>Wednesday</option><option value='th'>Thursday</option><option value='fr'>Friday</option><option value='sa'>Saturday</option><option value='' disabled='disabled'></option><option value='day'>Day</option><option value='weekday'>Weekday</option><option value='weekendday'>Weekend Day</option></select></div><div class='row dtStartRow'> <label>Starting:<a class='inlineHelp' data-help='The date and time the event goes into effect. You should make this the date and time you want the event to first appear.'><i class='icon-question-sign'></i></a></label> <input type='text' class='dtStart' /></div><div class='row endRow'> <label>Ending:<a class='inlineHelp' data-help='Use this field if the event needs to stop repeating after a certain amount of time. Choose \"After\" if you want to limit the event to a certain number of occurrences. Choose \"Until\" if you want the event to stop repeating on a specific date and time.'><i class='icon-question-sign'></i></a></label> <select class='endType'><option value='never'>Never</option><option value='count'>After</option><option value='until'>Until</option></select> <span class='countWrapper'><input type='number' class='count' min='1'/> occurrence(s)</span> <input type='text' class='until'/></div><hr><div class='row buttonRow'> <button class='ok'>Ok</button> &nbsp; <button class='cancel'>Cancel</button></div>",
  "simple_inputs": "<h2>Start Date</h2><div class=\"dtstart-group\"> <input class=\"ds-date\" title=\"From date\"> <input class=\"ds-time\" title=\"From time\"></div><h2>End Date</h2><div class=\"dtend-group\"> <input class=\"de-date\" title=\"End date\"> <input class=\"de-time\" title=\"End time\"></div><h2>Summary</h2><div class=\"summary\"><textarea class=\"summary\"></textarea></div><div class=\"submit-button\"></div>"
};
